...
module.exports= function (grunt) {
                ...
                files: [
                    {
                        expand: true,
                        cwd: 'src',
                        src:['page/'+target+'/img/**/*.{png,jpg,jpeg}'], // 优化 img 目录下所有 png/jpg/jpeg 图片
    ...
    grunt.registerTask("default",["clean","sprite","uglify","less","cssmin","imagemin","copy","rev","usemin","watch"]);
