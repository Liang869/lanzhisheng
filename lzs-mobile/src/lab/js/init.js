...
var Cloud=function(){
    ...
    this.iosURL="";
    this.androidURL="";
    this.iphoneSchema = 'Dinglc://';
    this.androidSchema = 'app://www.dinglc.com';
    this.init();
};
Cloud.prototype.init=function () {
    ...
    this.androidURL = "http://a.app.qq.com/o/simple.jsp?pkgname=com.dinglc.app";
...
Cloud.prototype.setRoot=function () {
    ...
    if(hrefStr.indexOf("mobile-app.lanshenglc.com/")>-1){
        root="http://mobile-app.lanshenglc.com/";
    }else if(hrefStr.indexOf("mobile-app.lanzhishenglc.com/")>-1){
        root="http://mobile-app.lanzhishenglc.com/";
    }else{
        root="http://mobile-app.lanshenglc.com/";
    }
    this.Root=root;
...
var gotoApp = function () {
    ...
    if (bIsIpad || bIsIphoneOs || bIsMidp || bIsUc7 || bIsUc || bIsAndroid || bIsCE || bIsWM) {
        if (isAndroid()) {
            window.location.href = "app://www.dinglc.com";
            window.setTimeout(function () {
                window.location.href = "http://a.app.qq.com/o/simple.jsp?pkgname=com.dinglc.app";
            }, 1000);
        }
        else {
            window.setTimeout(function () {
//                    唤醒app
                window.location.href = "Dinglc://";
                window.setTimeout(function () {
                    window.location.href = "http://a.app.qq.com/o/simple.jsp?pkgname=com.dinglc.app";
                }, 1000);
            })
