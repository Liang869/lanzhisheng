var app = new Vue({
    ...
    methods: {
        ...
        getCheckMsg:function(){
            var _this = this;
            _this.c.addCSC(["_trackEvent", "1801渠道注册页", "发送验证码"]);
                    ...
                    $.ajax({
                        ...
                        success:function(response){
                            ...
                            switch (response.code) {
                                case 200:
                                _this.c.addCSC(["_trackEvent", "1801渠道注册页", "验证码发送成功"]);
                                    var t=60;
                                    _this.checkTimer=setInterval(function(){
                                        if(t==0){
                                            clearInterval(_this.checkTimer);
                                            _this.checkTimer = 0;
                                            _this.btn_text="<img src='img/2.png' >";
        ...
        submit:function(){
            var _this = this;
            _this.c.addCSC(["_trackEvent", "1801渠道注册页", "点击注册"]);
            if(_this.form.phone == ""||_this.form.phone == null){
                layer.open({
                    content: '请输入手机号'
                    ,skin: 'msg'
            ...
            $.ajax({
                ...
                success:function(response){
                    ...
                    switch (response.code) {
                        case 200:
                        _this.c.addCSC(["_trackEvent", "1801渠道注册页", "注册成功"]);
                            layer.open({
                                content: '注册成功'
                                , skin: 'msg'
                                , time: 2 //2秒后自动关闭
                            ...
                            break;
                        case 400:
                        _this.c.addCSC(["_trackEvent", "1801渠道注册页", "注册失败"]);
                            layer.open({
                                content: '注册失败'
                                , skin: 'msg'
                                , time: 2 //2秒后自动关闭
        ...
        goAct:function(type,url){
            _this.c.addCSC(["_trackEvent", "1801渠道注册", "去"+type]);
        ...
        newBag:function(){
            var _this = this;
            if(_this.form.channel == 597 || _this.form.channel == 578){
                _this.href1 = 'https://mobile-app.lanzhishenglc.com/dist/page/actNewBag/index.html?channel=' + _this.form.channel;
            }else{
                _this.href1 = 'https://mobile-app.lanzhishenglc.com/dist/page/actNewBag/index.html';
            }
        },
        headBid:function(){
            var _this = this;
            if(_this.form.channel == 597 || _this.form.channel == 578){
                _this.href2 = 'https://mobile-app.lanzhishenglc.com/dist/page/actHeadBid/index.html?channel=' + _this.form.channel;
            }else{
                _this.href2 = 'https://mobile-app.lanzhishenglc.com/dist/page/actHeadBid/index.html';
            }
        },
        isWeixin:function(){
